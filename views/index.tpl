...
<body>
    ...
    <div class="banner">
        <h1>Bienvenidos a Runner's Choice S.A.C.</h1>
        <p>¡Encuentra el par perfecto para tus necesidades!</p>
    </div>
    ...
    <div class="catalog-table">
        ...
        <div class="product-item">
            ...
            <div class="product-info">
                ...
                <div class="product-details">Género: {{ producto['genero'] }}</div>
